...
/**
 * FunctionMap is an API that allows you to store and retrieve functions by string name.
 * FunctionMap is stored in a HashMap, where the key is a function name, and the value is a Function<T,R> instance.
 */
