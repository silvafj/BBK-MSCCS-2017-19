...
/**
 * SumOfSquares is a class that allows you to calculate a sum of squares in a provided range. It is
 * implemented using OO approach. Your task is to refactor the todo section using functional
 * approach. Your implementation should not use mutable variables, and should pass all the tests.
 */
public class SumOfSquares {
  ...
  static int calculateSumOfSquaresInRange(int startInclusive, int endInclusive) {
    ...
    return IntStream.range(startInclusive, endInclusive + 1).map(v -> v * v).sum();
  }
}
