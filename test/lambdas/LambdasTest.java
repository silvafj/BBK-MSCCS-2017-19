...
public class LambdasTest {
  ...
  public void testHelloSupplier() {
    Supplier<String> helloSupplier = Lambdas.helloSupplier();
  ...
  public void testIsEmptyPredicate() {
    ...
    boolean nonEmptyStringResult = isEmptyPredicate.test("fred");
  ...
  public void testToDollarStringFunction() {
    Function<BigDecimal, String> toDollarStringFunction = Lambdas.toDollarStringFunction();
  ...
  public void testLengthInRangePredicate() {
    Predicate<String> lengthInRangePredicate = Lambdas.lengthInRangePredicate(4, 10);
  ...
  public void testRandomIntSupplier() {
    IntSupplier randomIntSupplier = Lambdas.randomIntSupplier();
  ...
  public void testBoundedRandomIntSupplier() {
    IntUnaryOperator boundedRandomIntSupplier = Lambdas.boundedRandomIntSupplier();
  ...
  public void testIntSquareOperation() {
    IntUnaryOperator squareOperation = Lambdas.intSquareOperation();
  ...
  public void testStringToIntConverter() {
    ToIntFunction<String> stringToIntConverter = Lambdas.stringToIntConverter();
  ...
  public void testNMultiplyFunctionSupplier() {
    Supplier<IntUnaryOperator> fiveMultiplyFunctionSupplier = Lambdas.nMultiplyFunctionSupplier(5);
  ...
  public void testNewThreadRunnableConsumer() throws InterruptedException {
    Consumer<Runnable> newThreadRunnableConsumer = Lambdas.newThreadRunnableConsumer();
  ...
  public void testTrickyWellDoneSupplier() {
    Supplier<Supplier<Supplier<String>>> wellDoneSupplier = Lambdas.trickyWellDoneSupplier();
